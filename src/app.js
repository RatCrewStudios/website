        ...
        <main>
          ...
          <div className="section black" id="crew">
            ...
            <div className="members">
              ...
              desc="Lari always had a knack for numbers and is tasked with navigating the crew towards new adventures. He spends most of his free time playing video games, most often tactical shooters or action role-playing games. An avid fisherman, Lari is more than happy to return to countryside whenever the opportunity arises." />
          ...
          <div className="section black" id="contact">
            ...
            <p>Limingantie 5, 90400 Oulu</p>
            <iframe title="location" className="google-maps" src="https://maps.google.com/maps?q=Rat%20Crew%20Studios%20Oulu&t=&z=17&ie=UTF8&iwloc=&output=embed" 
            width="300" height="300"  frameborder="0" scrolling="no" marginheight="0" marginwidth="0" style={{ border: 0 }} allowFullScreen></iframe>
          </div>
