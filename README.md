...
* Restrict API key usage for maps: https://console.cloud.google.com/apis/credentials?project=rat-crew-studios
...
PCllä kotisivujen leveys ei tarvi olla koko näytön leveydellä vaan selkesti keskellä. (Katso kohta referessit.)  


HEADER ("Tumma osio") 

Pysyy aina ylhäällä vaikka sivua scrollaa

Hieman läpinäkyvä

Firman logo vasemmalla.

Tekstit valkoisella  

- About, Crew, Contact, Press

Mouse hover muuttaa tekstin taustan punaiseksi

Logoa painaessa sivu vierittyy takaisin alkuun


BANNER PICTURE

Vaihtuva kuva ja nuolet joita painamalla kuva vaihtuu

Jonkilainen delay että kuvat vaihtuu myös automaattisesti pikkuhiljaa


ABOUT ("Vaalea osio)

Lyhyt tekstipätkä meistä


CREW ("Tumma osio") 

Henkilökuvat ja esittelytekstit
...
Oma erillinen sivu jonne tulee pressi kamaa 


MAP ("Tumma osio") 

Joku google maps widgetti tai vastaava jossa näkyy firman osoite


SOCIAL MEDIA ("Vaalea osio")

Handlenappulat jotka vie aina nappuloita vastaavalle sivulle




Sivun alalaitaan sitten joku "all right reserved" teksti. 
...
http://www.layopigames.com/index.html
